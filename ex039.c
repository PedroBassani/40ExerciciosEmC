...
int main()
	...
	char H,M;
            ...
            CADASTRAR: i=i+1;DIM=i;
                    ...
                    printf("\n NOME da %io pessoa: \t",i);     scanf(" %s",&imcs[i].nome);
                    printf("\n ALTURA da %io pessoa: \t",i);   scanf(" %ld",&imcs[i].altura);
                    printf("\n PESO da %io pessoa: \t",i);     scanf(" %f",&imcs[i].peso);
                    printf("\n CPF da %io pessoa: \t",i);      scanf(" %i",&imcs[i].cpf);
            CONSULTAR:
                    printf("\n SEXO da %io pessoa: \t",i);
                    printf("\n < 1 - HOMEM > | < 2 - MULHER > ");
                    scanf("%i",&op);
